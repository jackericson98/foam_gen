...
if __name__ == '__main__':
    ...
    # density_vals = {0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1.0}
    cv_vals = {0.25, 0.5}
    density_vals = {0.5}
    my_string = "python foam_gen.py cv {:.3f} den {:.3f} num 1000 olp 0.5 dist gamma pbc t\n"
    number_of_foam_files = 50
    number_of_files = 1
