...
if __name__ == '__main__':
    ...
    my_string = "python foam_gen.py cv {:.3f} den {:.3f} num 1000 olp 1.0 dist gamma pbc t\n"
    ...
    for rroot, directories, files in os.walk(folder):
        for directory in directories:
            ...
            cv, den = round(float(dir_comps[1]), 3), round(float(dir_comps[2]), 3)
